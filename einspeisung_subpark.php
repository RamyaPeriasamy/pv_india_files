    ...
    if ($park_no == 10) {
		...
		if ($phase=="tag"){
			...
			if($subpark_id == 279){ // Inverter
				...
				$diagrammCode .='<tr><td>&nbsp;</td></tr>';
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagram9.php?park_no=43&phase=INV1G6&defaults=0,1,2,3,4&args=0,1,0,8379,Inv_PR,Inverter1%20PR,15,%,4;0,1,0,8414,Inv1_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,8414,Inv1_AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-6" border="0"></iframe></td></tr>';
				$diagrammCode .='<tr><td>&nbsp;</td></tr>';
				$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagram9.php?park_no=43&phase=INV1G7&defaults=0,1,2,3,4&args=0,1,0,8379,Inv1_DC_Vol_Coeff,Inv 1(DC_Voltage),15,V,4;0,1,0,8414,Inv1_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,8414,Inv1_AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-7" border="0"></iframe></td></tr>';
				$count = 7;
			}	
...
if($subpark_id==370){ // Inverter1
			...
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramRud.php?park_no=56&phase=RUDINV1EFF&args=0,1,0,11621,Inv1_Eff,Inverter1,15,%,8;&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 5" border="0"></iframe></td></tr>';
			
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramRud.php?park_no=56&phase=RUDINV1ACPR&defaults=0,1,2,3,4&args=0,1,0,11621,Inv_AC_PR_600,Inv1%20AC%20PR,15,%,4;0,1,0,12690,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-6" border="0"></iframe></td></tr>';
...
if($subpark_id==372){ // Energy Meter
	 if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=56&phase=RUDenergyg2&defaults=0,1,2,3&args=0,1,0,7772,System_PR,System PR,15,%,1;0,1,0,12690,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12690,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
	 ...
	 if ($phase=="tag"){
		...
		$count = 1;
		 ...
		 if ($phase=="tag"){
			...
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramIndus.php?park_no=54&phase=IndINV1EFF&args=0,1,0,12667,Inv_Eff,Inverter1,15,%,8;&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 5" border="0"></iframe></td></tr>';
		  ...
		  if ($phase=="tag"){
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=53&phase=INV1PR&defaults=0,1,2,3,4&args=0,1,0,11721,Inv_PR,Inv%20PR,15,%,4;0,1,0,11722,Inv_irrad_250,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12692,AC_Module_Temp_250,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-4" border="0"></iframe></td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			
			$diagrammCode .= '<tr><td align="left" valign="top"><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramroy.php?park_no=53&phase=RINV1EFF&args=0,1,0,11721,Inv1_Eff,Inverter1,15,%,8;&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph- 5" border="0"></iframe></td></tr>';
		...
		if ($subpark_id==376){ // Blk 2
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramorg.php?park_no=57&phase=ORGINV1ACPR&defaults=0,1,2,3,4&args=0,1,0,12028,Inv_AC_PR_600,Inv1%20AC%20PR,15,%,4;0,1,0,12029,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12028,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-6" border="0"></iframe></td></tr>';
			
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/argdiagramorg.php?park_no=57&phase=ORGINV1DCPR&defaults=0,1,2,3,4&args=0,1,0,12028,DC_Vol_Coeff,Inv1(DC_Voltage),15,V,4;0,1,0,12029,Inv_irrad_600,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12028,AC_Module_Temp_600,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-7" border="0"></iframe></td></tr>';
			...
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=58&phase=Polyenergyg2&defaults=0,1,2,3&args=0,1,0,12037,System_PR,System PR,15,%,1;0,1,0,12417,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,12417,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-2" border="0"></iframe></td></tr>';
			$count = 2;
...
if($subpark_id==425){ // Block A
	...
	if($subpark_id==429){ // Block E
		...
		if($subpark_id==433){ // weather station
			...
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
			$diagrammCode .= '<tr><td><iframe id="frame1" width="99%" height="99%" SRC="diagram/energydiagram.php?park_no=72&phase=FortINV1PR&defaults=0,1,2,3,4&args=0,1,0,13478,Inv_PR,Inv1%20PR,15,%,4;0,1,0,13475,Inv_irrad_250,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,13475,AC_Module_Temp_250,Module Temperature,15,&deg;C,\'darkred\'&hideClear=1&hideDelta=1&stamp=' . $stamp . '&endstamp=' . $endstamp . '&title=Graph-4" border="0"></iframe></td></tr>';
			$diagrammCode .='<tr><td>&nbsp;</td></tr>';
